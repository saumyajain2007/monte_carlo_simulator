    ...
    class Builder:
        ...
        def _create(self, __skip_cache: bool) -> SparkSession:
            ...
            if (
                ...
                return self._from_sdkconfig(
                    ...
                    self._validate_session_enabled, __skip_cache=__skip_cache)
            ...
            if nb_session is not None:
                if __skip_cache:
                    raise Exception(
                        "[UNSUPPORTED] DatabricksSession.builder.create() without additional "
                        "parameters is not supported in Databricks notebooks and jobs. Specify "
                        "connection parameters, for example through "
                        "DatabricksSession.builder.remote(...).create(), "
        ...
        def _from_sdkconfig(
            ...
            **kwargs,
            ...
            session = RemoteSparkSession.builder.channelBuilder(channel_builder).create()
